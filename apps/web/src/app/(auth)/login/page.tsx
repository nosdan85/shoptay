...
import { ServerInvite } from "@/components/discord/server-invite";
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-background to-muted/20 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-gothic text-2xl">Welcome</CardTitle>
          <CardDescription>
            Login with Discord to access your account, make purchases, and manage your wallet.
          </CardDescription>
        </CardHeader>
